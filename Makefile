CXX := clang++
CXXFLAGS := -O -std=c++11 -Werror -Weverything -Wno-c++98-compat -Wno-global-constructors -Wno-exit-time-destructors -Wno-old-style-cast -Wno-c++98-compat-pedantic -Wno-padded
